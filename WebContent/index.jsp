...
<script language="javascript">
	...
	function adddowncount(){
		...
		if(downcount >= 10){
		$("#downlink").css("color","yellow"); 
		$("#downcount").css("color","yellow"); 
		}
	...
	function addupcount(){
		...
		if(upcount >= 10){
			$("#uplink").css("color","red"); 
			$("#upcount").css("color","red"); 
		}
			...
			<div class="post" id="Message">
				...
				<div class="meta">
					...
					<p class="down" onclick="adddowncount()">
						<a id="downlink" href="javascript:void(0);">Down: </a><a id="downcount">0</a>
					</p>
					<p class="up" onclick="addupcount()">
						<a id="uplink" href="javascript:void(0);">Up: </a><a id="upcount">0</a>
					</p>
				</div>
			</div>
			<div class="post">
