...
public class CodeAction extends ActionSupport implements SessionAware,
	...
	public String generateCode() throws IOException {
		...
		String[] codeStr = { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J",
		...
		// 图象生效
		g.dispose();
		//((ServletRequest) session).setAttribute("mycode", randomCode.toString());
		if(session.get("mycode") != null){
			session.remove("mycode");
		}
		session.put("mycode", randomCode.toString());
